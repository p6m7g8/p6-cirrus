...
#<
#
# Function: p6_aws_svc_log_group_delete(log_group_name)
#
#  Args:
#	log_group_name -
#
...
#<
#
# Function: p6_aws_svc_logs_groups_prefix_delete(prefix)
#
#  Args:
#	prefix -
#
#>
######################################################################
p6_aws_svc_logs_groups_prefix_delete() {
    local prefix="$1"
    ...
    for log_group_name in $(p6_echo $log_group_names); do
        p6_aws_svc_log_group_delete "$log_group_name"
    done
